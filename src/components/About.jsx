...
const About = () => {
	return (
		<section id='about' className='bg-white h-[75vh] container border-b border-gray-200 px-8 lg:px-8 2xl:px-20 pt-[9rem] lg:pt-[3.75rem] flex flex-col justify-start items-start'>
