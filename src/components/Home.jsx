...
const Home = () => {
	return (
		<section id='home' className='h-screen container border-b border-gray-300 px-6 lg:px-8 2xl:px-32 pt-[9rem] lg:pt-[3.75rem] flex flex-col lg:flex-row-reverse justify-start lg:justify-center items-center'>
			<img src={links[0].picture} className='w-1/2 lg:w-1/3 rounded-[100%] py-[6rem] lg:py-0 transition-all duration-300'></img>	

			<div className='flex flex-col justify-between items-center lg:items-start flex-grow'>
				<p className='text-9xl lg:text-8xl text-center lg:text-left'>Hello there! <span className='animate-waving inline-block'>👋🏻</span></p>
				<p className='text-4xl lg:text-lg text-center lg:text-left leading-relaxed mt-8 mb-auto lg:pb-12 text-gray-400'>I'm Steven Sikorski, a Computer Science Undergraduate from New York City. 🗽</p>
				...
				<div className='flex flex-col lg:flex-row justify-center item-center pb-[6rem] lg:pb-0'>
					...
					<ul className='flex justify-center pt-2 lg:pt-0'>
						...
						<img className='techstack' alt='Lua' src='https://upload.wikimedia.org/wikipedia/commons/c/cf/Lua-Logo.svg'></img>
						...
						<img className='techstack' alt='Tailwind' src='https://upload.wikimedia.org/wikipedia/commons/7/7d/Microsoft_.NET_logo.svg'></img>
					</ul>
				</div>
			</div>
		</section>
