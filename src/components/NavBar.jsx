...
const NavBar = () => {
	return (
		<nav className='w-full bg-white border-b border-black text-black fixed'>
			<div className="h-[6rem] lg:h-[3.75rem] max-w-screen-2xl mx-auto flex justify-between items-center transition-all duration-300 px-4 lg:px-2 2xl:px-16">

				{/* Icon */}
				<a href={links[0].website}>
					<img src={icon} alt='logo' className='h-12 w-12 lg:h-8 lg:w-8'></img>
				</a>

				{/* Name */}
				<p className='ml-3 mr-auto text-2xl lg:text-base'>
					Steven Sikorski
				</p>
				...
				<ul className='list-none flex'>
					...
					<a href={links[0].email} target='_blank' rel='noreferrer'>
						<li className='h-16 w-16 lg:h-10 lg:w-10 navbar-button'>
							<VscMail className='h-8 w-8 lg:h-6 lg:w-6'/>
						</li>
					</a>
